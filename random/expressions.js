...
let negA = -a; // assigning -5 to negA
...
console.log(1 > 0 && 2 > 1); // true // No value is false
console.log(1 > 0 && 2 < 1); // false // 2 < 1 is false

console.log(1 > 0 || 2 > 1); // true // No value is false
console.log(1 > 0 || 2 < 1); // true // 2 < 1 is false
console.log(1 < 0 || 2 < 1); // false // Both values are false

console.log(!(1 > 0)); // false // 1 > 0 is true
console.log(!(1 < 0)); // true // 1 < 0 is false
